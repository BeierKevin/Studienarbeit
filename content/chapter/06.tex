...
\section{Neuerstellung des CO2 Rechner}
...
% Hier halt ausarbeiten was genau gemcht würde wie es jetzt aussieht und was die Vorteile sind

\section{Übernahme und anpassung des Dashboard}

% TODO: Anforderung [R01] umsetzen
% TODO: Anforderung [R05] umsetzen

Geht hier halt darum darüber zu sprechen das man halt vom Alten Code halt sehr viel übernehmen konnte und hauptsächlich kleinere anpassungen welche Framework spezifisch waren.

Dafür kann man vlt ein beispiel machen und dann auch Eine der Karten zeigen wie es jetzt so aussieht auf der neuen Seite!
