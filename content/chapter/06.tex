...
Und zu guter Letzt wurde noch eine FAQ-Seite der neuen CO2-Runter Webseite hinzugefügt. Der Hintergrund dafür bestand darin, dass es bisher keine Möglichkeit gab, Nutzern Informationen zu geben, die nicht direkt mit dem CO2-Rechner oder dem Dashboard zu tun haben.

Die FAQ-Seite soll Nutzern die Möglichkeit geben, Antworten auf häufig gestellte Fragen zu finden und zusätzlich eine Literaturliste enthalten, die die Nutzer:innen nutzen können, um sich weiter zu informieren.
...
Die Literaturliste wird in einer Tabelle dargestellt, die es den Nutzern ermöglicht, die Literaturquellen zu durchsuchen und auf die Quellen zuzugreifen. Die Tabelle enthält eine Spalte für den Titel der Quelle, eine Spalte für den Autor, eine Spalte für das Erscheinungsjahr und eine Spalte für den Link zur Quelle. Die Tabelle ist durchsuchbar und paginiert, um die Benutzerfreundlichkeit zu verbessern.
...
Das finale Design der FAQ-Seite sieht sehr modern und übersichtlich aus und lädt den Nutzer dazu ein, sich weiter zu informieren.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/06/FAQ-Design.jpeg}
