...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{images/06/Calculator_New_Design.png}
...
\begin{lstlisting}[language={JavaScript}, caption={CurrentCO2.vue}]
<template>
...
\begin{lstlisting}[language={JavaScript}, caption={QuestionStepper.vue}]
<template>
    <v-stepper>
        <v-stepper-header>
...
\begin{lstlisting}[language={JavaScript}, caption={QuestionBlock.vue}]
<template>
    <div
