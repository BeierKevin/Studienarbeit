...
Wenn die NutzerInnen sich dazu entscheiden, den Button \texttt{CO2 Rechner Starten} zu betätigen, werden sie auf eine Seite weitergeleitet, die in Abbildung \ref{fig:co2runterapp-rechner} dargestellt ist.
