...
%erwähnen, dass es Probleme beim Rechner gab. Die letzte Kategorie funktionierte auf "detailliert" nicht und musste deshalb für unsere Zwecke komplett neu entwickelt werden (Formeln, Werte etc)
